...
export class PromoController {
  ...
  async searchPromo(req: express.Request, res: express.Response) {
    const percent = req.query.percent ? Number.parseInt(req.query.percent as string) : 0 ; // number
  ...
  buildRouter(): express.Router {
    ...
    router.delete("/:id", this.deletePromo.bind(this));
    router.patch("/:id", this.updatePromo.bind(this));
    return router;
  }
}