...
export const BurgerModel = mongoose.model<BurgerDocument>('Burger',burgerSchema);
export const BurgerProductsModel = mongoose.model<BurgerProductsDocument>('BurgerProducts',burgerProductsSchema);