...
export class IngredientService {
    ...
    async getIngredientById(id: string): Promise<IngredientDocument | ApiErrorCode> {
    ...
    async getIngredientIdByName(name: string): Promise<IngredientDocument | ApiErrorCode> {
    ...
    async searchIngredients(search: IngredientSearch): Promise<IngredientDocument[] | ApiErrorCode> {
    ...
    async updateIngredient(id:string, update: IngredientUpdate): Promise<IngredientDocument | ApiErrorCode> {
        if(!Types.ObjectId.isValid(id)) {
            return ApiErrorCode.invalidParameters;
        }
